      ...
      <div class="collapse navbar-collapse" id="navbarResposive">
        <ul class="navbar-nav ml-auto">
         ...
         @guest
          ...
          <li class="nav-item active">
            <a
              href="{{ route('login') }}"
              class="btn btn-success px-4 text-white nav-link"
              >Sign In</a
            >
          </li>
         @endguest
        ...
        <ul class="navbar-nav d-none d-lg-flex">
          <li class="nav-item dropdown">
              ...
              >
              <img src="/images/user_pc.png" alt="" / class="rounded-circle
              mr-2 profile-picture"> Hi. {{ auth()->user()->name }}
              </a>
              <div class="dropdown-menu ml-3" data-aos="fade-up">
          ...
          <li class="nav-item">
              <a href="{{ route('cart') }}" class="nav-link d-inline-block mt-2">
                @php
                    $carts=\App\Model\Cart::where('user_id',Auth::user()->id)->count();
                @endphp
                @if ($carts > 0)
        ...
        <!-- mobile -->
          ...
          <li class="nav-item">
              <a href="#" class="nav-link">Hi. Mangga</a>
          </li>
