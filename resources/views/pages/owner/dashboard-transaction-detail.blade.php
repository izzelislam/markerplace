            ...
            <div class="card">
                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="product-subtitle">{{ number_format($transaction->transaction->total) }}</div>
                        </div>
                        <div class="col-12 col-md-6">
                    ...
                    <form action="{{ route('dashboard-transaction-update', ['id'=>$transaction->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                                ...
                                <div class="col-12 col-md-8">
                                    <div class="row">
                                        ...
                                        <div class="product-subtitle">
                                            {{ $transaction->transaction->user->addres_one }}
                                        </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                        <div class="product-title">
                                        ...
                                        <div class="product-subtitle">
                                            {{ App\Models\Province::find($transaction->transaction->user->provincies_id)->name }}
                                        </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                        <div class="product-title">Citys</div>
                                        <div class="product-subtitle ">
